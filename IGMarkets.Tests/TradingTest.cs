...
namespace IGMarkets.Tests
{
    ...
    public class TradingTest : Helpers
    {
        ...
        public async Task Accounts_GetAccounts()
        {
            ...
            // Assert
            HttpTest.ShouldHaveCalled("https://demo-api.ig.com/gateway/deal/accounts")
        ...
        public async Task ClientApplication_GetApplication()
        {
            ...
            // Assert
            HttpTest.ShouldHaveCalled("https://demo-api.ig.com/gateway/deal/operations/application")
                .WithVerb(HttpMethod.Get)
                .WithHeader("VERSION", 1)
                .WithHeader("X-IG-API-KEY")
                .WithOAuthBearerToken();
        ...
        #region Tests for /positions

        [Test]
        public async Task Positions_EmptyResult()
        {
            // Arrange
            var trading = Connect();
            var jsonFile = $"positions_emptyresult.json";
            HttpTest.RespondWith(LoadResource(jsonFile));
            ...
            // Assert
            HttpTest.ShouldHaveCalled("https://demo-api.ig.com/gateway/deal/positions")
                .WithVerb(HttpMethod.Get)
        ...
        public async Task MarketNavigation_GetHierarchy(string jsonFile)
        {
            ...
            // Assert
            HttpTest.ShouldHaveCalled("https://demo-api.ig.com/gateway/deal/marketnavigation/")
                .WithVerb(HttpMethod.Get)
                .WithHeader("VERSION", 1)
                .WithHeader("X-IG-API-KEY")
                .WithOAuthBearerToken();
        ...
        public async Task Session_Refresh()
        {
            ...
            HttpTest.RespondWithJson(newRefreshToken);
        ...
        public async Task Session_RefreshingTokenIfObsolete()
        {
            ...
            HttpTest.RespondWithJson(new { errorCode = "error.security.oauth-token-invalid" }, 401); // simulating a invalid token response from IG for the first call
        ...
        public void Session_RaisingFatalExceptionIfCannotRefreshToken()
        {
            // Arrange
            var trading = Connect();
            HttpTest.RespondWithJson(new { }); // empty response
